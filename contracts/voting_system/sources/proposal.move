...
module voting_system::proposal;
    ...
    */
    ...
    fun issue_vote_proof(proposal: &Proposal, vote_yes: bool, ctx: &mut TxContext){
        ...
        let vote_yes_img = new_unsafe_from_bytes(b"https://phucqb.sirv.com/vote_yes_img.jpg");
        let vote_no_img = new_unsafe_from_bytes(b"https://phucqb.sirv.com/vote_no_img.jpeg");
        
        let url = if(vote_yes) {vote_yes_img} else {vote_no_img};
