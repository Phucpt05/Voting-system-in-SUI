  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300 flex flex-col">
        <Navbar />
        <div className="flex-grow max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
          <Pages />
        </div>
          ...
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="md:flex md:items-center md:justify-between">
              <div className="flex justify-center md:justify-start space-x-6">
                <a href="https://github.com/Phucpt05/Voting-system-in-SUI" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
              ...
              <div className="mt-8 md:mt-0 md:order-1">
                <p className="text-center text-base text-gray-400 dark:text-gray-500">
                  &copy; 2025 Voting DApp. All rights reserved.
                </p>
              </div>
            </div>
          </div>
