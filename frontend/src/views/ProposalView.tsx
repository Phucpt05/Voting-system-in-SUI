  ...
  return (
    <div className="mb-12">
        <div className="text-center mb-10">
            ...
            <div className=''>
                <div className="inline-flex items-center px-4 py-2 bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 rounded-lg border border-amber-200 dark:border-amber-800 mb-6">
                    <svg className="w-5 h-5 mr-2 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span className="text-sm font-medium">Only publisher (package transaction) can use functions as delist, activate and create proposal - "use branch prompt_engineer to more capabilities"</span>
                </div>
                <div>
                    <button
